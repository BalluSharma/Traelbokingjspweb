...
<%
   ...
   String a = request.getParameter("busfrom");  // from the form 'name' attribute
   String b = request.getParameter("busto");    // from the form 'name' attribute
   ...
   try {
       ...
       String cmd = "INSERT INTO busdata(busfrom, busto, departuredate, pickuptime) VALUES ('"+a+"', '"+b+"', '"+c+"', '"+d+"')";
       ...
       if(row > 0){
           ...
           response.sendRedirect("Busbookingdata.jsp");
       } else {
